...
4. Selecione a pasta `atividade-arrow-functions-js`.
5. Abra uma das pastas de atividade.
6. Abra o arquivo `index.html` no navegador ou use a extensão Live Server.
